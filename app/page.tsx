      ...
      <section className={styles.seoSection}>
        <div className={styles.container}>
          <div className={styles.seoPanel}>
            ...
            <p className={styles.seoPanelText}>
              We are open Open 24 Hours — St Clair Cannabis is here to serve you. Our live menu is constantly refreshed with the freshest drops, premium prerolls, artisan edibles, and everything in between. Whether you're winding down or stocking up for the weekend, our knowledgeable staff is always here for you.
            </p>
            <p className={styles.seoPanelText}>
